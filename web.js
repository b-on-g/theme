...
;
	($.$bog_theme_demo) = class $bog_theme_demo extends ($.$mol_example_large) {
		Theme(){
			const obj = new this.$.$bog_theme_auto();
			return obj;
		}
		...
		Theme_select(){
			...
			(obj.dictionary) = () => ((this.theme_dictionary()));
			(obj.value) = (next) => ((this.theme_current(next)));
			(obj.options) = () => ((this.theme_options()));
			return obj;
		}
		Theme_field(){
			const obj = new this.$.$mol_form_field();
			(obj.name) = () => ("Theme");
			(obj.Content) = () => ((this.Theme_select()));
			return obj;
		}
		Theme_toggle(){
		...
		Base(){
			const obj = new this.$.$bog_theme_demo_case();
	...
	($mol_mem(($.$bog_theme_demo.prototype), "Theme"));
	($mol_mem(($.$bog_theme_demo.prototype), "theme_current"));
	($mol_mem(($.$bog_theme_demo.prototype), "Theme_select"));
	($mol_mem(($.$bog_theme_demo.prototype), "Theme_field"));
	($mol_mem(($.$bog_theme_demo.prototype), "Theme_toggle"));
	($mol_mem(($.$bog_theme_demo.prototype), "hue"));
	($mol_mem(($.$bog_theme_demo.prototype), "Hue"));
	($mol_mem(($.$bog_theme_demo.prototype), "Hue_field"));
	...
	($mol_mem(($.$bog_theme_demo_case.prototype), "Card2_text"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Card2"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Card1_text"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Card1"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Back"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Line"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Text"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Field"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Shade"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Focus"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Control"));
	($mol_mem(($.$bog_theme_demo_case.prototype), "Hover"));
