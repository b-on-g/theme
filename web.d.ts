...
declare namespace $ {
    const $bog_theme: Record<"image" | "line" | "text" | "background" | "focus" | "back" | "hover" | "card" | "current" | "special" | "control" | "shade" | "field" | "spirit", $mol_style_func<"var", unknown>>;
...
declare namespace $ {
	...
	type $bog_theme_toggle__theme_auto_bog_theme_demo_1 = $mol_type_enforce<
		ReturnType< $bog_theme_demo['Theme'] >
		,
		ReturnType< $bog_theme_toggle['theme_auto'] >
	>
	type $mol_form_field__name_bog_theme_demo_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_theme_demo_3 = $mol_type_enforce<
		ReturnType< $bog_theme_demo['Theme_toggle'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_number__value_bog_theme_demo_4 = $mol_type_enforce<
		ReturnType< $bog_theme_demo['hue'] >
		,
		ReturnType< $mol_number['value'] >
	>
	type $mol_number__precision_change_bog_theme_demo_5 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_number['precision_change'] >
	>
	type $mol_form_field__name_bog_theme_demo_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_theme_demo_7 = $mol_type_enforce<
		ReturnType< $bog_theme_demo['Hue'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_number__value_bog_theme_demo_8 = $mol_type_enforce<
		ReturnType< $bog_theme_demo['hue_spread'] >
		,
		ReturnType< $mol_number['value'] >
	>
	type $mol_number__precision_change_bog_theme_demo_9 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_number['precision_change'] >
	>
	type $mol_form_field__name_bog_theme_demo_10 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_theme_demo_11 = $mol_type_enforce<
		ReturnType< $bog_theme_demo['Hue_spread'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_row__sub_bog_theme_demo_12 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	type $bog_theme_demo_case__theme_bog_theme_demo_13 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_theme_demo_case['theme'] >
	>
	type $bog_theme_demo_case__theme_bog_theme_demo_14 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_theme_demo_case['theme'] >
	>
	type $bog_theme_demo_case__theme_bog_theme_demo_15 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_theme_demo_case['theme'] >
	>
	type $bog_theme_demo_case__theme_bog_theme_demo_16 = $mol_type_enforce<
		...
		ReturnType< $bog_theme_demo_case['theme'] >
	>
	type $bog_theme_demo_case__title_bog_theme_demo_17 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_theme_demo_case['title'] >
	>
	type $bog_theme_demo_case__inner_bog_theme_demo_18 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $bog_theme_demo_case['inner'] >
	>
	type $mol_scroll__sub_bog_theme_demo_19 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $.$$ {
    class $bog_theme_demo extends $.$bog_theme_demo {
        hue_deg(): string;
        hue_spread_deg(): string;
    }
}
